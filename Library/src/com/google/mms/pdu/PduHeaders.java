...
public class PduHeaders {
	 ...
	 * @return the octet value of the pdu header with specified header field. Return
	...
	protected void setOctet(int value, int field) throws InvalidHeaderValueException {
		/**
		 * Check whether this field can be set for specific header and check validity of
		 * the field.
		 */
		switch (field) {
		case REPORT_ALLOWED:
		...
		case RETRIEVE_STATUS:
			// According to oma-ts-mms-enc-v1_3, section 7.3.50, we modify the invalid
			// value.
			...
			break;
		case STORE_STATUS:
			// According to oma-ts-mms-enc-v1_3, section 7.3.58, we modify the invalid
			// value.
		...
		case RESPONSE_STATUS:
			// According to oma-ts-mms-enc-v1_3, section 7.3.48, we modify the invalid
			// value.
	 ...
	 *
	 * @param field the field
	 * @return the EncodedStringValue value of the pdu header with specified header
	 *         field
	 */
	 ...
	 *
	 * @param field the field
	 * @return the EncodeStringValue array of the pdu header with specified header
	 *         field
	 */
	 ...
	 * @param value the value
	 * @param field the field
	 * @return the EncodedStringValue value array of the pdu header with specified
	 *         header field
	 * @throws NullPointerException if the value is null.
	 */
